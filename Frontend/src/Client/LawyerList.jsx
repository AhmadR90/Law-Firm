...
const lawyerCategories = [
  {
    ...
    image:
      "https://i.pinimg.com/736x/e8/4f/e6/e84fe6bc3c5bfe7907103d91a4877049.jpg", // Replace with actual image paths
  },
  {
        ...
        {lawyerCategories.map((lawyer, index) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <button className="mt-4 w-full bg-amber-500 text-gray-900 py-2 rounded-lg font-semibold hover:bg-amber-600 transition">
                Get Started →
              </button>
            </div>
          </div>
